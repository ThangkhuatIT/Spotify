...
authRoute.post('/login', validateLogin, wrapCallbacksInTryCatch(authController.login))
authRoute.get('/verify-email/:token/:id', wrapCallbacksInTryCatch(authController.verifyEmail))
